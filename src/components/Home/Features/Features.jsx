    ...
    return (
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 my-10 md:flex items-center scroll-smooth'>
            <div className='md:w-1/2 pt-10 pr-10'>
                <h1 className='text-2xl md:text-3xl lg:text-4xl font-bold mb-2'>We have everything you need</h1>
                <p className='text-base font-medium mb-5'>We provided premium services to our customers. We provided a best studying environment for our students. Also we provided solutions for mental and physical satisfaction like sports, cultural program.</p>
